					...
					<tbody id="row" style="font: bold; text-align: center;">
						<c:forEach items="${labor }" var="labor">
							<tr>
								...
								<td>${labor.level }</td>
								<td>
								<a onclick="if (! confirm('are you sure delete labor : ${labor.nameoflabor} ?')) { return false; }" href="deletelabor/${labor.laborid }"><button class="btn-outline-danger">Delete</button></a>
